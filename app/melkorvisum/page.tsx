	...
	return (
		<div className="flex flex-col items-center ">
			...
			<div className="flex grid grid-cols-12 py-20 md:py-32 border-b border-slate-200 dark:border-slate-700 ">
				...
				<Image removeWrapper alt="MelkorVisum_screenshot" shadow="lg" radius="none" className="max-w-4xl w-full col-span-12 lg:col-start-6 lg:col-span-7" src="/mr1.webp"></Image>
			</div>
			<div className="flex flex-col-reverse lg:grid grid-cols-12 lg:grid-rows-1 py-20 md:py-32 justify-center items-center border-b border-slate-200 dark:border-slate-700 lg max-w-7xl items-center">
				<Image removeWrapper alt="MelkorVisum_screenshot" shadow="lg" radius="none" className="max-w-4xl w-full col-span-12 lg:col-span-7" src="/trakcni.webp"></Image>
