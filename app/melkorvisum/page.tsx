...
export default function DocsPage() {
	return (
		<div className="flex flex-col items-center mx-auto w-full">
				<div className="w-full flex flex-col items-center py-20 md:pb-32 border-b border-slate-200 dark:border-slate-700  bg-center bg-cover bg-no-repeat bg-melkor-pattern2 ">
				...
				<Image removeWrapper alt="Macbook_view" radius="none" className="w-full xl:w-7/12 mx-auto" src="/macbook2.webp"></Image>
				</div>
				</div>
...
<div className="max-w-7xl px-6 ">
			...
			<div className="flex grid grid-cols-12 py-20 md:py-32 border-b border-slate-200 dark:border-slate-700">
				...
				<Image removeWrapper alt="MelkorVisum_screenshot" shadow="lg" radius="none" className="max-w-4xl w-full col-span-12 lg:col-start-6 lg:col-span-7 dark:shadow-light" src="/mr1.webp"></Image>
			</div>
			<div className="flex flex-col-reverse lg:grid grid-cols-12 lg:grid-rows-1 py-20 md:py-32 justify-center items-center border-b border-slate-200 dark:border-slate-700items-center">
				<Image removeWrapper alt="MelkorVisum_screenshot" shadow="lg" radius="none" className="dark:shadow-light3 max-w-4xl w-full col-span-12 lg:col-span-7" src="/trakcni.webp"></Image>
