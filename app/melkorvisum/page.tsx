...
export default function DocsPage() {
	...
	return (
		...
		<section className="flex flex-col items-center mx-auto w-full">
			...
			<div className="max-w-7xl px-6 ">
				<div
					className="w-full flex flex-col items-center lg:pb-32 pb-20 pt-20  border-b border-slate-200 dark:border-slate-700 ">
				...
				<div className="flex justify-center items-center grid grid-cols-12 py-20 md:py-32 border-b border-slate-200 dark:border-slate-700">
					<div
					className="flex flex-col col-span-12 lg:col-span-4  lg:items-start ">
							<motion.div
							initial={{ opacity: 0 }}
				...
				<div
					className="flex flex-col py-20 md:py-32 items-center border-b border-slate-200 dark:border-slate-700">
					<motion.h1
							initial={{ opacity: 0 }}
							whileInView={{ opacity: 1, scale: 1 }}
							transition={{ duration: 0.5 }}
